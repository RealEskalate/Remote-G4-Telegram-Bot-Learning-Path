...
### 2. Create a telegram bot that registers users and store their data on temporary storage then on Mongodb or any of your prefered database:
   ...
   - **Note:** ⚠⚠⚠⚠ If you decide to use the database set in Exercise folder, make sure to go to Part_4/Exercise/database/loader.py then change the database name to [Your_First_Name].⚠⚠⚠⚠ The collection name can stay the same as 'mycollection'
