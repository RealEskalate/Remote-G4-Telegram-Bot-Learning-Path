...
logged_users_reply_keyboard = ReplyKeyboardMarkup( resize_keyboard=True, one_time_keyboard=True, keyboard=[[btn_menu_memes], [btn_menu_chat], [btn_menu_show_profile]])
